...
public class MapperSupportImpl<T> implements MapperSupport<T> {
    ...
    public MapperSupportImpl(JdbcTemplate jdbcTemplate, Class entityClass, String tableName, Field primaryKeyF, String primaryKey, Map<String, Field> columnNameMap, RowMapper<T> rowMapper) {
        this.jdbcTemplate = jdbcTemplate;
        this.entityClass = entityClass;
        this.tableName = tableName;
        this.primaryKeyF = primaryKeyF;
        this.primaryKey = primaryKey;
        this.columnNameMap = columnNameMap;
        this.rowMapper = rowMapper;
    }

    public MapperSupportImpl(Class<T> entityClass, DataSource dataSource) {
        this(entityClass,new JdbcTemplate(dataSource));
    }

    public MapperSupportImpl(Class entityClass, JdbcTemplate jdbcTemplate ) {
        this.jdbcTemplate = jdbcTemplate;
        this.entityClass = entityClass;
        init();
    }

    public MapperSupportImpl() {
